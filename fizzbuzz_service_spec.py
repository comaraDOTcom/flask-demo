...
# as a developer (we do so much copy and paste) then by doing RGB, we will be sure our methods work
...
#this is green phase (passing). this is a good way to start as we are iteratively improving our code.
